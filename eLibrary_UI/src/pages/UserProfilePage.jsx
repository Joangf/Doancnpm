...
import Library from "../components/UserProfile/Library";
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M20.5833 22.75L13 17.3333L5.41663 22.75V5.41667C5.41663 4.84203 5.6449 4.29093 6.05123 3.8846C6.45756 3.47827 7.00866 3.25 7.58329 3.25H18.4166C18.9913 3.25 19.5424 3.47827 19.9487 3.8846C20.355 4.29093 20.5833 4.84203 20.5833 5.41667V22.75Z"
            stroke="white"
            strokeWidth="2.5"
            strokeLinecap="round"
        ...
        <aside className="profile-sidebar">
          <div className="user-info">
            ...
            <div className="user-details">
              ...
              <p className="user-subtitle" style={{
                color: activeSubscriptionPlan == 'BASIC' ? '#AAAAAA' : '#FFD700'
              }}> {activeSubscriptionPlan} </p>
            </div>
          </div>
